...
import {CarritoSchema, ProductoSchema} from './graphql/schema.js';
import {obtenerProductos, obtenerProducto, crearProducto, updateProducto, deleteProducto,obtenerCarrito,obtenerCarritos,crearCarrito,updateCarrito,deleteCarrito} from './graphql/resolvers.js';
...
app.use('/api/graphql/productos', graphqlHTTP({
...
app.use('/api/graphql/carritos', graphqlHTTP({
